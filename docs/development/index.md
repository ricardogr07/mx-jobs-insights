...
This section keeps the internal project contracts discoverable after the public-first MkDocs navigation lands.

## Internal Docs
- [Source Data Contract](source-data-contract.md)
- [Public Data Policy](public-data-policy.md)
- [Presentation Policy](presentation-policy.md)
- [Phase 1 Ingest And Curate Usage](phase-1-ingest-curate-usage.md)
