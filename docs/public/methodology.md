...
This public site is generated from completed report artifacts, not from direct raw-source reads. / Este sitio publico se genera a partir de artefactos de reportes ya generados y no desde lecturas directas de las fuentes crudas.
...
- Site generation copies only public-safe CSV downloads and HTML report snapshots into the public site source. / La generacion del sitio copia solo descargas CSV seguras para publico y snapshots HTML al sitio publico.
